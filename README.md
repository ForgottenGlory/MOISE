# MOISE
Morrowind Overall Improvement Suite Enhanced is a basic, primarily graphical overhaul for Morrowind GOTY edition. It includes all of the necessities required to begin a Morrowind modding adventure.
